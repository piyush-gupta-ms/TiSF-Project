    ...
    return (
        <section className="h-[calc(100vh-100px)] flex flex-col">
            <div className="px-auto w-full py-5 bg-gray-100">
                <h1 className="font-black text-5xl text-center">Isolation</h1>
                <h5 className="text-center mt-2">
                    Transactions occur independently of each other, ensuring
                    that the outcome of one transaction does not affect others. <br />
                    After both the transactions are completed the new balance will reflect the appropriate balance considering both the transactions. <br />
                    If either of the transaction fails, the other will carry on, unaffected.
                </h5>
            </div>
            <div className="flex justify-evenly items-center flex-grow  relative">
                <div className="flex flex-col items-center">
                    ...
                    />
                    <button
                        className="invisible mt-4 py-2 px-10 rounded-md bg-black text-white font-semibold"
                        onClick={() => {
                    ...
                    <p
                        className={`${
                            message1 ? "" : "invisible"
                        } invisible px-4 mt-4 py-2 bg-red-500 text-white`}
                    >
                        {message1 ? message1 : "\u00A0"}
                    </p>
                </div>
                ...
                <div className="absolute flex flex-col justify-center items-center">
                    ...
                    <button
                        ...
                        onClick={() => {
                            if (isNaN(parseInt(tempAmount1))) {
                                setMessage1("Enter valid amount for User 1");
                                return;
                            }
                            if (amount1 < tempAmount1) {
                                setMessage1("Not enough amount in User 1");
                                return;
                            }
                            if (isNaN(parseInt(tempAmount2))) {
                                setMessage2("Enter valid amount for User 2");
                                return;
                            }
                            if (amount2 < tempAmount2) {
                                setMessage2("Not enough amount in User 2");
                                return;
                            }
                            handleTransaction(tempAmount2, 2);
                            handleTransaction(tempAmount1, 1);
