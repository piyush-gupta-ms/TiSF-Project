...
export default function Home() {
    ...
    <section className="h-[calc(100vh-100px)] flex flex-col">
            <div className="px-auto w-full py-5 bg-gray-100">
                <h1 className="font-black text-5xl text-center">Home</h1>
                <h5 className="text-center mt-2">
                    This page shows a very basic system which does not follow ACID properties. It only checks for numerical values for amounts. <br />
                    All the ACID properties are demonstrated in thier respective sections. 
                </h5>
                <h6 className="text-center mt-2">
                    Note: Each section is independent of others, so the balances are not synchronised.
                </h6>
            </div>
